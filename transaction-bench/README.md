...
```shell
solana-transaction-bench -ul --authority funding.json top-off --accounts-file payers.json --balance 1SOL
solana-transaction-bench -ul --authority funding.json top-off --accounts-file payers.json --balance 1SOL --reclaim-excess
solana-transaction-bench -ul --authority funding.json top-off-tpu --accounts-file payers.json --balance 1SOL --num-max-open-connections 8 --send-fanout 1 ws-leader-tracker
```
