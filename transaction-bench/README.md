...
```shell
solana-transaction-bench -ul --authority funding.json top-off --accounts-file payers.json --balance 1SOL ws-leader-tracker
solana-transaction-bench -ul --authority funding.json top-off --accounts-file payers.json --balance 1SOL --reclaim-excess ws-leader-tracker
solana-transaction-bench -ul --authority funding.json top-off --accounts-file payers.json --balance 1SOL --use-rpc
```
